...
@section('title', 'Dolly-Harris || Trang Chủ')
                    ...
                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                        ...
                        <div class="carousel-caption d-none d-md-block text-left align-items-center">
                            ...
                            <a class="btn btn-lg ws-btn wow fadeInUpBig" href="{{ route('product-grids') }}"
                                role="button">Tìm hiểu ngay<i class="far fa-arrow-alt-circle-right"></i></a>
                        </div>
                    </div>
                @endforeach
            </div>
                                ...
                                <div class="single-product">
                                    <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#{{ $product->id }}"
                                                    title="Quick View" href="#"><i class=" ti-eye"></i><span>Xem
                                                        qua sản phẩm</span></a>
                                                <a title="Wishlist"
                                                    href="{{ route('add-to-wishlist', $product->slug) }}"><i
                                                        class=" ti-heart "></i><span>Thêm vào danh sách yêu
